...
# E.g., for peer 0 at org 1, get info of my channel will do
# channelGetInfo mychannel 1 0
channelGetInfo () {
	local channel=$1
	local org=$2
	local peer=$3
...
chaincodeInstantiate () {
	...
	local policy="OR ('Org1MSP.member','Org2MSP.member','Org3MSP.member','Org4MSP.member')"  # endorsement policy
